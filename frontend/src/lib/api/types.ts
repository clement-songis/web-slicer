...
export type { PrinterResponse } from '../../generated/api/PrinterResponse';
export type { SavePrinterRequest } from '../../generated/api/SavePrinterRequest';
export type { TestPrinterResponse } from '../../generated/api/TestPrinterResponse';
